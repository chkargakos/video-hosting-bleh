...
app.get('/video/latest', async function(req, res) {
    res.json({ url: `http://92.42.46.150:8080/videos?v=${db.fetch(db.fetch("latestNum") + "_fname")}` });
});

app.get('/image/latest', async function(req, res) {
    res.json({ url: `http://92.42.46.150:8080/files/${db.fetch(db.fetch("latestP") + "_pname")}` });
});

app.get('/audio/latest', async function(req, res) {
    res.json({ url: `http://92.42.46.150:8080/files/${db.fetch(db.fetch("latestA") + "_aname")}` });
});
...
<head>
    ...
    <meta property="og:video" content="http://92.42.46.150:8080/files/${link}" />
    <meta property="og:video:secure_url" content="http://92.42.46.150:8080/files/${link}" />
    <meta property="og:video:type" content="application/x-shockwave-flash" />
    <meta property="og:video:width" content="600" />
    <meta property="og:video:height" content="400" />
    <title>92.42.46.150:8080 | ${link}</title>
...
<body>
    ...
    <a style="font-size:28px;" href="/main">back to main</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="http://92.42.46.150:8080/files/${link}" id="linkCopy"> <button onclick="copy()">To Clipboard</button>&nbsp;<button onclick="window.location.reload();">Random Video</button>
    <p></p>
</body>
</html>
    `);
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
    <meta property="og:image" content="http://92.42.46.150:8080/files/${link}" />
    <title>92.42.46.150:8080 | ${link}</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <style>
        body {
...
<body>
   ...
   <a style="font-size:28px;" href="/images">back to images</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="http://92.42.46.150:8080/files/${link}" id="linkCopy"> <button onclick="copy()">To Clipboard</button>&nbsp;<button onclick="window.location.reload();">Random Image</button>
   <p></p>
   </center>
</body>
</html>
...
app.use("/main", async function(req, res) {
    ...
    for (var i = vids.length - 1; i >= 0; i--) {
        ...
        ${username}: <a href="/videos?v=${vidnam}">${vids[i].data}</a>
        <br>`);
    }
...
<html lang="en"><head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
    <title>92.42.46.150:8080 | criminally unsafe video streaming (how is this still up)</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <style>
        body {
            width: 100%;
    ...
    <meta content="92.42.46.150:8080" property="og:title" />
    <meta content="world's most unsafe video streaming website" property="og:description" />
    <meta content="http://92.42.46.150:8080" property="og:url" />
...
app.get("/embed", async function(req, res) {
    ...
    res.send(`<iframe width="1004" height="753" src="http://92.42.46.150:8080/files/${name}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`);
});
...
app.get("/videos", async function(req, res) {
    ...
    <head>
        ...
        <meta name="twitter:image" content="http://92.42.46.150:8080/thumbnail/${fixd}.jpg" />
        <meta name="twitter:player" content="http://92.42.46.150:8080/files/${fixd}" />
        <meta name="twitter:player:width" content="320" />
        <meta name="twitter:player:height" content="180" />
        <meta name="twitter:player:stream" content="http://92.42.46.150:8080/files/${fixd}" />
        <meta name="twitter:player:stream:content_type" content="video/mp4" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
        <title>92.42.46.150:8080 | trim.13da2ae9-9bb2-47c8-90c4-6623b32e90f7.mov</title>
        <meta property="og:site_name" content="tube.cristpz.eu">
        <meta property="og:title" content="${author}">
        <meta property="og:image" content="http://92.42.46.150:8080/thumbnail/${fixd}.jpg"> 
        <meta property="og:video:type" content="text/html">
        <meta property="og:video:url" content="http://92.42.46.150:8080/files/${fixd}">
        ...
        <meta property="og:url" content="http://92.42.46.150:8080/videos?v=${fixd}">
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
        <style>
            body {
                width: 100%;
        ...
        <link rel="stylesheet" href="http://92.42.46.150:8080/files/style.css">
        <script src="http://92.42.46.150:8080/files/script.js" defer></script>
    </head>
    ...
    <body>
        ...
        <div class="contents">
            ...
            <a style="font-size:28px;" href="/main">back to main</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="http://92.42.46.150:8080/files/${fixd}" id="linkCopy"> <button onclick="copy()">To Clipboard</button>
            <p></p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0">
    <meta property="og:image" content="http://92.42.46.150:8080/files/dox.jpg" />
    <meta property="og:image:width" content="800" />
    <meta property="og:image:height" content="800" />
    <meta property="og:title" content="you should dox yourself now" />
    <meta property="og:url" content="http://92.42.46.150:8080/dox" />
    <title>92.42.46.150:8080 | doxxed</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
    <style>
        body {
            width: 100%;
